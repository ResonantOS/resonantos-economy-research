...
| [time-capsule-live-intake-refine](entries/time-capsule-live-intake-refine.md) | strategy-result | `strategy-result`, `dispatch`, `subagents`, `review`, `refine`, `implementation-boundary`, `time-capsule` | Full form/database/safety Refine: 34 review findings, 22 change requests, and a four-layer plan with a non-collecting simulator first; both live states remain gated. |
| [deferred-contribution-basis](entries/deferred-contribution-basis.md) | strategy-result | `strategy-result`, `dispatch`, `subagents`, `synthesis`, `tower`, `validation-scaffold`, `definitions`, `resonantos-economy` | Five-lane prior-art and fixture-handoff result plus three open bets: recognition utility, community utility, and bilingual communication safety; mechanism remains blocked before fixture use. |
...
| [contribution-measurement-failure-allocation-guide](entries/contribution-measurement-failure-allocation-guide.md) | synthesis | `synthesis`, `workflow`, `prizes`, `bets`, `resonantos-economy` | Anonymized workshop-derived guide separating contribution description, planning, result recognition, failure evidence, conflict-aware review, and opportunity allocation; six experiments remain unregistered and unrun. |
| [mechanism-directed-prior-art](entries/mechanism-directed-prior-art.md) | workflow | `prior-art`, `tower`, `bets`, `workflow`, `resonantos-economy` | Bet-linked, negative-precedent-first research route for every relevant subtower; returns revise witnesses but cannot validate mechanisms. |
| [contribution-mechanism-tower](entries/contribution-mechanism-tower.md) | strategy-result | `strategy-result`, `dispatch`, `subagents`, `tower`, `review`, `prior-art`, `bets`, `resonantos-economy` | Full contribution-mechanism tower scaffold plus unregistered research and downstream review proposals; Goodhart is one cross-cutting attack lane, not the whole subject. |
| [monetary-circulation-tower](entries/monetary-circulation-tower.md) | strategy-result | `strategy-result`, `dispatch`, `subagents`, `tower`, `prior-art`, `token-boundary`, `synthesis`, `resonantos-economy` | Closed fifth-tower source research with 23 component precedents, MC-R, generic MC-E6 KILL, all surviving local handoffs `unrunnable`, and final auditor ACCEPT; no monetary experiment ran. |
| [current-state-mental-map](entries/current-state-mental-map.md) | synthesis | `synthesis`, `workflow`, `tower`, `definitions`, `resonantos-economy` | Visual dependency map of accepted research, killed propositions, blocked or unrun handoffs, human gates, and the smallest legitimate next contributions. |
...
| [repository-onboarding-experiment-literacy](entries/repository-onboarding-experiment-literacy.md) | strategy-result | `strategy-result`, `dispatch`, `subagents`, `synthesis`, `onboarding`, `ergonomics`, `prizes`, `bets`, `resonantos-economy` | Accepted research for a story-led front porch and derived experiment-example gallery; mechanics already exist, while newcomer usability and story-first superiority remain killed until audience witnesses run. |
| [whisper-repo-readme-writing-patterns](entries/whisper-repo-readme-writing-patterns.md) | strategy-result | `strategy-result`, `dispatch`, `subagents`, `synthesis`, `skills`, `onboarding`, `workflow`, `resonantos-economy` | Registered research dispatch separating repo-readme source behavior, reader evidence, local Whisper ownership, and documentation migration boundaries before any preset or writing-rule mutation. |
...
- The monetary-circulation source dispatch is closed `resolved` with auditor
  ACCEPT. It refined object boundaries and future schema obligations, but no
  local monetary handoff is runnable and no mechanism was validated.
