...
| `harvest` | Local source harvesting into source records, selectors, notation, residue, and inventory. |
...
| `snapshot-closure` | Rules for using copied snapshots without excessive expansion requests. |
| `strategy-result` | Inventoried lanes, subagents, flow, gate state, and next action for a strategy/proposal. |
| `subagents` | Multi-agent dispatch strategy or support tooling. |
