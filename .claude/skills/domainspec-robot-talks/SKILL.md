---
name: domainspec-robot-talks
description: Run a DomainSpec-style intra-group robot-talks discussion for a dispatch group with `robot_talks: true`.
---
...
**Full rationale & templates:** `ops/subagents-strategy/constitution/robot-talks-constitution.md`
