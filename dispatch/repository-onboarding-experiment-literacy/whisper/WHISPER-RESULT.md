...
- Spell: `whisper`
- Transport: `repository_onboarding`
- Transport proof status: `unproven`
- Objective: create a down-to-earth, story-led repository entry with plain bet
...
- Candidate selected: `story_then_owner_routes`, because it preserves the human
  problem and routes mechanics to existing owners without extending the already
  long walkthrough
